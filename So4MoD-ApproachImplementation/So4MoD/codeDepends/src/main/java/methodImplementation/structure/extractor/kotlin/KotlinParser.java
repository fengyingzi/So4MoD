// Generated from D:/Development/idea_projects/depends-0.9.6/src/main/antlr4/depends/extractor/kotlin\KotlinParser.g4 by ANTLR 4.9.1
...
public class KotlinParser extends Parser {
	...
	public final LineStringLiteralContext lineStringLiteral() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 149)) & ~0x3f) == 0 && ((1L << (_la - 149)) & ((1L << (LineStrRef - 149)) | (1L << (LineStrText - 149)) | (1L << (LineStrEscapedChar - 149)) | (1L << (LineStrExprStart - 149)))) != 0)) {
				{
				setState(1926);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final LineStringContentContext lineStringContent() throws RecognitionException {
		...
		try {
			...
			setState(1945);
			_la = _input.LA(1);
			if ( !(((((_la - 149)) & ~0x3f) == 0 && ((1L << (_la - 149)) & ((1L << (LineStrRef - 149)) | (1L << (LineStrText - 149)) | (1L << (LineStrEscapedChar - 149)))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final MultiLineStringContentContext multiLineStringContent() throws RecognitionException {
		...
		try {
			...
			setState(1951);
			_la = _input.LA(1);
			if ( !(((((_la - 155)) & ~0x3f) == 0 && ((1L << (_la - 155)) & ((1L << (MultiLineStrRef - 155)) | (1L << (MultiLineStrText - 155)) | (1L << (MultiLineStrEscapedChar - 155)))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
